		...
		<?php } ?>
         ...
         <div id="field1zzv-container" class="field f_100">
               ...
               <label for="field1zzv">
 				 ...
 				 <?php wp_dropdown_users(array('name' => 'camp_post_author','selected'=>$camp_post_author , 'role__in' =>array( 'Administrator','Editor' ))); ?>
